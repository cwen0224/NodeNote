export const NODENOTE_AI_PROMPT = [
  ...
  '14. 若要表達可選分支，請用多條 edge，不要把一切塞在單一文字裡。',
  '15. 若要表達資料夾內頁，最多 7 層。',
  '16. 若使用中文 key，請先正規化成英文 canonical key，再把中文保留在 label 或內容。',
  '17. 如果資訊不足，請補齊常見最佳實務，不要留下空白 placeholder。',
  '18. 內容要有清楚層次，避免所有節點擠在同一區，座標請合理分散避免重疊。',
  '19. 如果是故事內容，請讓節點具備開場、展開、轉折、收束、結尾。',
  '20. 如果是筆記內容，請讓節點具備主題、子題、參考、延伸、結論。',
  '',
  '最小範例結構：',
  '{',
  '  "schemaVersion": "1.0.0",',
